...
class WebScraperClass:
    ...
    def __init__(self):
        self.url = "https://www.edarabia.com/prayer-times-berlin/"
    ...
    def get_prayer_times(self):
        ...
        #could do it with local but don't want to change it
        month_mapping = {
        "Jan": "Jan", "Feb": "Feb", "Mär": "Mar", "Apr": "Apr",
        "Mai": "May", "Jun": "Jun", "Jul": "Jul", "Aug": "Aug",
        "Sep": "Sep", "Okt": "Oct", "Nov": "Nov", "Dez": "Dec"
        }
        month_de = tomorrow_date_raw.strftime("%b")
        month_en = month_mapping.get(month_de, month_de)


        tomorrow_date = f"{month_en} {tomorrow_date_raw.strftime('%d')}"
